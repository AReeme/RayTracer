...
{
	//light
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 5, 5.0f, 3 }, 1.0f, std::make_unique<Emmisive>(color3{ 40, 40, 40 })));

	//objects
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 0, 0.5f, -1 }, 0.5f, std::make_unique<Lambertian>(color3{ 0.5f, 0, 1 })));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 1.25f, 0.5f, -1 }, 0.5f, std::make_unique<Metal>(color3{ 1, 1, 1 }, 0.1f)));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ -1.25f, 0.5f, -1 }, 0.5f, std::make_unique<Dilectric>(color3{ 1, 1, 1 }, 2.0f)));
